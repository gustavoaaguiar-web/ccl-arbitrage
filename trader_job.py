...
# VALO se sacó del universo el 13/jul/2026: no está en el panel Merval de
# IOL ni tampoco cedearizado en el panel CEDEARs — sin fuente ARS
# confiable para operarlo dentro de este sistema.
CEDEAR_SWING_SET = {
